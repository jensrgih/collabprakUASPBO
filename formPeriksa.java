            ...
            if(jumlah_baris == 0){
                ...
                try {
                    ...
                    while(i < jumlah_baris){
                        ...
                        + "(No_Periksa,Kode_obat,nama_obat,harga_obat,jumlah_obat) "
 ...
 private void tampildetailpemeriksaan(String sql){
  DefaultTableModel datalist = new DefaultTableModel();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 0, 510, 40));

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel4.setText("Siap Melayani Anda 24 Jam");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 42, 176, 20));

        jLabel5.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel5.setText("Jalan Farel Subagiyo No.28");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 60, -1, 20));

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel6.setText("Call Center  0998-878780");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 80, 180, -1));
        ...
        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 140, 980, 10));
        ...
        jPanel1.add(Btn_Simpan, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 530, -1, -1));
        ...
        jPanel1.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 350, -1, -1));

        Cmb_periksa.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jPanel1.add(Txt_penyakit, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 350, 106, -1));
        jPanel1.add(Txt_gejala, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 430, 110, -1));

        Gridobat.setAutoCreateRowSorter(true);
        Gridobat.setBackground(new java.awt.Color(255, 0, 204));
        ...
        jPanel1.add(Txt_jumlahitem, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 500, 80, -1));

        jLabel23.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jLabel23.setText("Jumlah Obat yg dikenakan");
        jPanel1.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 220, 170, 20));
        ...
        jPanel1.add(Txt_jumlahobat, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 242, 170, 30));
        ...
        jPanel1.add(Txt_jumlahtotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 530, 80, -1));
        ...
        Gridperiksa.setBackground(new java.awt.Color(255, 204, 204));
        ...
        jPanel1.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 280, -1, -1));
        ...
        jPanel1.add(Txt_totalharga, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 300, 160, 30));
        jPanel1.add(Tanggal_periksa, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 160, -1, -1));

        jLabel30.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ikon0/pital.png"))); // NOI18N
        jLabel30.setText("jLabel30");
        jPanel1.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 330, 140));

        btnCetak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ikon3/print-16x16.png"))); // NOI18N
        ...
        jPanel1.add(btnCetak, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 530, -1, -1));
            ...
            RsObat=st.executeQuery(sql);
                while(RsObat.next()){
                    Txt_namaobat.setText(RsObat.getString("nama_obat"));
                     ...
                     Txt_hargaobat.setText(RsObat.getString("harga_obat"));
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        // TODO add your handling code here:
try {
           InputStream is = paneldata.class.getResourceAsStream("/laporan/dataPeriksa.jasper");
